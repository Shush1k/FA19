...
INSERT INTO `Airport`.`Rout` (`idRout`, `city_from`, `city_to`, `cost`, `flightTime`) VALUES (2, 'Москва', 'Самара', 3000, '2:20');
...
START TRANSACTION;
USE `Airport`;
INSERT INTO `Airport`.`Plane` (`idPlane`, `model`, `seats`, `madeYear`) VALUES (1, 'boing 1225', 200, 2010);
INSERT INTO `Airport`.`Plane` (`idPlane`, `model`, `seats`, `madeYear`) VALUES (2, 'Ан-2', 16, 1990);
