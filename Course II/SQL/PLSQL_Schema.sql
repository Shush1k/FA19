...
CREATE TABLE  "COUNTRIES"
   ("COUNTRY_ID" NUMBER(4,0), 
	...
	"COUNTRY_NAME" VARCHAR2(70) CONSTRAINT "CNAME_NN" NOT NULL ENABLE, 
	...
	CONSTRAINT "CRTY_PK" PRIMARY KEY ("COUNTRY_ID")
	USING INDEX  ENABLE
   );
...
ALTER TABLE  "COUNTRIES" ADD CONSTRAINT "COUNTR_REG_ID_FK1" FOREIGN KEY ("REGION_ID") REFERENCES  "REGIONS" ("REGION_ID") ENABLE;
CREATE INDEX "CTRY_REG_IDX" ON "COUNTRIES" ("REGION_ID");

--Create currencies table
CREATE TABLE  CURRENCIES 
   ("CURRENCY_CODE" VARCHAR2(7), 
	"CURRENCY_NAME" VARCHAR2(40) CONSTRAINT "CURR_NN" NOT NULL ENABLE, 
	"COMMENTS" VARCHAR2(150), 
	CONSTRAINT "CURR_PK" PRIMARY KEY ("CURRENCY_CODE")
	USING INDEX  ENABLE
   );
...
CREATE TABLE  LANGUAGES
   ("LANGUAGE_ID" NUMBER(4,0), 
	"LANGUAGE_NAME" VARCHAR2(50) CONSTRAINT "LANG_LANGNAME_NN" NOT NULL ENABLE, 
	CONSTRAINT "LANG_PK" PRIMARY KEY ("LANGUAGE_ID")
	USING INDEX  ENABLE
   );
...
CREATE TABLE  SPOKEN_LANGUAGES
   ("COUNTRY_ID" NUMBER(4,0), 
	...
	CONSTRAINT "SPOKEN_LANG_PK" PRIMARY KEY ("COUNTRY_ID", "LANGUAGE_ID")
	USING INDEX  ENABLE
   );

-- Add FK constraints
ALTER TABLE  SPOKEN_LANGUAGES ADD CONSTRAINT "CTRY_NUM_FK1" FOREIGN KEY ("COUNTRY_ID")
	REFERENCES  COUNTRIES ("COUNTRY_ID") ENABLE;

ALTER TABLE  SPOKEN_LANGUAGES ADD CONSTRAINT "LANG_ID_FK2" FOREIGN KEY ("LANGUAGE_ID")
...
-- Populate currencies
INSERT INTO currencies(currency_code, currency_name, comments)
...
Values(1800,'460 Bloor St. W.','ON M5S 1X8','Toronto','Ontario',2);
INSERT INTO locations (location_id, street_address, postal_code, city, state_province, country_id)
Values(2500,'Magdalen Centre, The Oxford Science Park','OX9 9ZB','Oxford','Oxford',44);
INSERT INTO locations (location_id, street_address, postal_code, city, state_province, country_id)
Values(1400,'2014 Jabberwocky Rd','26192','Southlake','Texas',1);
INSERT INTO locations (location_id, street_address, postal_code, city, state_province, country_id)
Values(1500,'2011 Interiors Blvd','99236','South San Francisco','California',1);
INSERT INTO locations (location_id, street_address, postal_code, city, state_province, country_id)
Values(1700,'2004 Charade Rd','98199','Seattle','Washington',1);
INSERT INTO locations (location_id, street_address, postal_code, city, state_province, country_id)
Values(2100,'Av. Rio Branco','20090-003','Rio de Janeiro','Rio de Janeiro',55);
...
INSERT INTO departments (department_id, department_name, manager_id, location_id)
Values(80,'Sales - Europe',149,2500);
INSERT INTO departments (department_id, department_name, manager_id, location_id)
...
VALUES(100,'Steven','King','SKING','515.123.4567',TO_DATE('2002-06-17','yyyy-mm-dd'),'AD_PRES',24000,null,null,90);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(101,'Neena','Kochhar','NKOCHHAR','515.123.4568',TO_DATE('2004-09-21','yyyy-mm-dd'),'AD_VP',17000,null,100,90 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(102,'Lex','De Haan','LDEHAAN','515.123.4569',TO_DATE('2008-01-13','yyyy-mm-dd'),'AD_VP',17000,null,100,90 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(200,'Jennifer','Whalen','JWHALEN','515.123.4444',TO_DATE('2002-09-17','yyyy-mm-dd'),'AD_ASST',4400,null,101,10 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(205,'Shelley','Higgins','SHIGGINS','515.123.8080',TO_DATE('2009-06-07','yyyy-mm-dd'),'AC_MGR',12000,null,101,110 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(206,'William','Gietz','WGIETZ','515.123.8181',TO_DATE('2009-06-07','yyyy-mm-dd'),'AC_ACCOUNT',8300,null,205,110 );
...
VALUES(149,'Eleni','Zlotkey','EZLOTKEY','011.44.1344.429018',TO_DATE('2015-01-29','yyyy-mm-dd'),'SA_MAN',10500,.2,100,80, '1500' );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id, bonus)
VALUES(174,'Ellen','Abel','EABEL','011.44.1644.429267',TO_DATE('2011-05-11','yyyy-mm-dd'),'SA_REP',11000,.3,149,80,'1700' );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id, bonus)
VALUES(176,'Jonathon','Taylor','JTAYLOR','011.44.1644.429265',TO_DATE('2013-03-24','yyyy-mm-dd'),'SA_REP',8600,.2,149,80,'1250' );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(178,'Kimberely','Grant','KGRANT','011.44.1644.429263',TO_DATE('2014-05-24','yyyy-mm-dd'),'SA_REP',7000,.15,149,null );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(124,'Kevin','Mourgos','KMOURGOS','650.123.5234',TO_DATE('2014-11-16','yyyy-mm-dd'),'ST_MAN',5800,null,100,50);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(141,'Trenna','Rajs','TRAJS','650.121.8009',TO_DATE('2010-10-17','yyyy-mm-dd'),'ST_CLERK',3500,null,124,50 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(142,'Curtis','Davies','CDAVIES','650.121.2994',TO_DATE('2012-01-29','yyyy-mm-dd'),'ST_CLERK',3100,null,124,50 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(143,'Randall','Matos','RMATOS','650.121.2874',TO_DATE('2013-03-15','yyyy-mm-dd'),'ST_CLERK',2600,null,124,50 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(144,'Peter','Vargas','PVARGAS','650.121.2004',TO_DATE('2013-07-09','yyyy-mm-dd'),'ST_CLERK',2500,null,124,50 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(103,'Alexander','Hunold','AHUNOLD','590.423.4567',TO_DATE('2005-01-03','yyyy-mm-dd'),'IT_PROG',9000,null,102,60 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(104,'Bruce','Ernst','BERNST','590.423.4568',TO_DATE('2006-05-21','yyyy-mm-dd'),'IT_PROG',6000,null,103,60 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(107,'Diana','Lorentz','DLORENTZ','590.423.5567',TO_DATE('2014-02-07','yyyy-mm-dd'),'IT_PROG',4200,null,103,60 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(201,'Michael','Hartstein','MHARTSTE','515.123.5555',TO_DATE('2011-02-17','yyyy-mm-dd'),'MK_MAN',13000,null,100,20 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(202,'Pat','Fay','PFAY','603.123.6666',TO_DATE('2013-08-17','yyyy-mm-dd'),'MK_REP',3900,null,201,20 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(207,'Sophia','Barbosa Souza','SBARBOSASOUZA','55.24.6280.6935',TO_DATE('2009-03-12','yyyy-mm-dd'),'SR_SA_REP',9500,.2,149,85);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(208,'Diego','Silva Pinto','DSILVAPINTO','55.24.8806.9837',TO_DATE('2009-10-25','yyyy-mm-dd'),'SA_REP',7500,.15,149,85);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(209,'Sarah','Alves Rocha','SALVESROCHA','55.24.9381.2160',TO_DATE('2011-02-06','yyyy-mm-dd'),'SA_REP',7300,.15,149,85);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(210,'Lucas','Almeida Castro','ALMEIDACASTRO','55.24.6514-5378',TO_DATE('2012-08-16','yyyy-mm-dd'),'SA_REP',7300,.2,149,85);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(212,'Nick','Hooper','NHOOPER','011.44.1886 6663',TO_DATE('2012-09-01','yyyy-mm-dd'),'SR_SA_REP',9600,.2,149,80);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(215,'Donna','Steiner','DSTEINER','843.452.5959',TO_DATE('2004-11-02','yyyy-mm-dd'),'SR_MK_REP',8600,null,201,20);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(216,'George','Bell','GBELL','724.647.4299',TO_DATE('2014-04-01','yyyy-mm-dd'),'SR_ST_CLRK',3500,null,124,50 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(217,'Lisa','TAYLOR','LTAYLOR','417.730.8202',TO_DATE('2013-02-09','yyyy-mm-dd'),'MK_REP',4000,null,201,20 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(219,'Michael','Stocks','MSTOCKS','662.314.6844',TO_DATE('2015-12-16','yyyy-mm-dd'),'MK_REP',3700,null,201,20 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(220,'Tiffany','Heiden','THEIDEN','413.251.0684',TO_DATE('2015-07-06','yyyy-mm-dd'),'ST_CLERK',2600,null,124,50 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(222,'Chen','Li','CLI','423.817.1481',TO_DATE('2008-08-29','yyyy-mm-dd'),'IT_PROG',8000,null,103,60 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(223,'Alain','Fontaine','AFONTAINE','601.424.8816',TO_DATE('2013-11-18','yyyy-mm-dd'),'IT_PROG',7800,null,103,60 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(224,'Matthias','Reinhard','MREINHARD','315.496.2466',TO_DATE('2007-07-25','yyyy-mm-dd'),'AC_ACCOUNT',8100,null,205,110 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(225,'Katia','Hernandez','KHERNANDEZ','214.350.4575',TO_DATE('2011-06-13','yyyy-mm-dd'),'AD_ASST',4300,null,101,10 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(226,'Guido','Ricci','GRICCI','305.269.9415',TO_DATE('2015-05-17','yyyy-mm-dd'),'AD_ASST',4100,null,101,10 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(227,'Mizuto','Saikawa','MSAIKAWA','541.831.2444',TO_DATE('2012-02-01','yyyy-mm-dd'),'AD_ASST',4400,null,101,10 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(228,'Nabil','Safwah','NSAFWAH','720.863.0485',TO_DATE('1997-01-06','yyyy-mm-dd'),'MK_REP',5000,null,201,20 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(231,'Jelena','Duric','JDURIC','505.514.1583',TO_DATE('2009-05-11','yyyy-mm-dd'),'AC_ACCOUNT',5400,null,205,110 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(232,'Jennifer','Loermans','JLOERMANS','213.447.9053',TO_DATE('2013-04-14','yyyy-mm-dd'),'AC_ACCOUNT',5200,null,205,110 );
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
VALUES(235,'Alice','Newton','ANEWTON','314.248.7709',TO_DATE('2015-12-16','yyyy-mm-dd'),'MK_REP',4900,null,201,20 );
