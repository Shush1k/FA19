...
# p-value близится к 1 => принимаем Н0,
# H1 - остатки нормально распределены
...
resettest(lm_c)
# принимаем H0, p-value = 0.38 => нет пропущенных переменных
